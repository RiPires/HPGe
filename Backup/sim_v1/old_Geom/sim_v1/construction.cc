...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
    ...
    ///solidDetector = new G4Box("solidDetector", xWorld/nCols, yWorld/nRows, 0.01*m); //  small box
    solidDetector = new G4Box("solidDetector", 0.40*m, 0.40*m, 0.01*m); //  Big Box
    ...
    //   Defines a physical detector adding coordinates to the logical detector  //
    physDetector = new G4PVPlacement(0, G4ThreeVector(0., 0., 0.49*m), logicDetector, "physDetector", logicWorld, false, true);
